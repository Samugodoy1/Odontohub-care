...
export const CARE_CASES: readonly CareCase[] = [
  ...
  },
  {
    ...
    lede: "Siso, dente comprometido ou extração simples. Profissionais habituados a esses procedimentos e atentos ao pós-operatório.",
  ...
  },
  {
    ...
    lede: "Falta um dente, ou mais. Profissionais que planejam a reposição com cuidado e explicam cada etapa.",
  ...
  },
  {
    ...
    lede: "Dor profunda ou latejante, inclusive à noite. Encontre profissionais que tratam canal.",
  ...
  },
  {
    ...
    lede: "Dentes amarelados ou manchados. Clareamento com avaliação profissional e cuidado clínico.",
  ...
  },
  {
    ...
    shortLabel: "Criança",
    headline: "Criança.",
    title: "Dentista para crianças",
    lede: "Primeira consulta, dente de leite ou medo de dentista. Odontopediatras preparados para acolher crianças.",
  ...
  },
  {
    ...
    lede: "Dor intensa, trauma ou inchaço. Encontre profissionais que atendem casos urgentes e consulte a disponibilidade da clínica.",
